      ...
      <div className="absolute inset-0 bg-black text-white min-h-screen z-50">
        <div className="bg-white p-8 grid gap-4">
          <div>
            ...
            <button onClick={() => setShowAllPhotos(false)} className="fixed right-12 top-8 flex gap-1 py-2 px-4 rounded-2xl bg-black text-white">
          ...
          {place.photos?.[0] && (
            <div style={{ height: "508px", width: "100%" }}>
              <Image
                ...
                className="aspect-square cursor-pointer object-cover h-full w-full"
                src={place.photos[0]}
                alt=""
              />
            </div>
